...
export function SpearmintMouthRinseIngredients({
  variant = "spearmint",
}: {
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-[640px] gap-4 px-6 py-24">
        ...
        <div className="grid grid-cols-2">
          <p className={cn(nunitoBold.className, "text-base")}>Spearmint Oil</p>
          <p className={cn(nunitoRegular.className, "text-base opacity-70")}>
            Freshens breath and leaves a cool mint aftertaste with each rinsing.
          </p>
        </div>
